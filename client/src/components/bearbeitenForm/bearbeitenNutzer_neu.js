...
class bearbeitenNutzer_neu extends Component {
    constructor(props) {
      super(props);
  ...
  bearbeitenNutzer_neu.propTypes = {
  ...
  export default connect(mapStateToProps, { updateNutzer, getNutzer })(withRouter(bearbeitenNutzer_neu));
